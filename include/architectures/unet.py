...
VGG16
'''
def vgg(name, input_height, input_width, number_classes, metrics = None):
    ...
    optimizer = Adam(lr=9e-4) # lr is learning rate 3e-4
...
MobileNetV2
'''
def mobilenet(name, input_height, input_width, number_classes, metrics = None):
